        ...
        <form onSubmit={handleSubmit} className="flex">
          <div className="p-6.5 w-full">
            ...
            <InputField
              className={"w-full mb-4.5"}
              id={"tool_day_price"}
              label={"Tool day price"}
              type={"number"}
              placeholder={"Enter tool day price"}
            ...
            <InputField
              ...
              required={true}
              id={"tool_month_price"}
              label={"Tool month price"}
              type={"number"}
              placeholder={"Enter tool month price"}
            ...
            <InputField
              ...
              required={true}
              id={"tool_year_price"}
              label={"Tool year price"}
              type={"number"}
              placeholder={"Enter tool year price"}
            ...
            <InputField
              ...
              label={"Tool none price month"}
              type={"number"}
              placeholder={"Enter tool none price"}
              value={values.tool_none_price_month}
              onChange={handleChange}
              onBlur={handleBlur}
              error={
                touched.tool_none_price_month && errors.tool_none_price_month
              }
            />
            <InputField
              className={"w-full mb-4.5"}
              ...
              label={"Tool none price year"}
              type={"number"}
              placeholder={"Enter tool none price year"}
              value={values.tool_none_price_year}
              onChange={handleChange}
              onBlur={handleBlur}
              error={
                touched.tool_none_price_year && errors.tool_none_price_year
              }
            />
            <Textarea
              rows={2}
            ...
            <div className="flex flex-col gap-3">
              <FormikCheckboxItem
                label={"Can open link in browser ?"}
                id="isLink"
                name="isLink"
                value={values.isLink}
              />
