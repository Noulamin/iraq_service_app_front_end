...
interface CihBankOrderDetailsInfoModalPlansProps {
  modalOpen: boolean;
  packDetails: any;
  setModalOpen: Function;
}

const CihBankOrderDetailsInfoModalPlans: React.FC<
  CihBankOrderDetailsInfoModalPlansProps
          ...
          <div className="w-full flex items-start flex-col px-8 text-black">
            ...
            >
              <div>
                ...
                {` 1 month of ${packDetails?.pack_name} Pack`}
              </div>

              <div className="mt-1">
                <span className="font-bold">Total : </span>{" "}
                {packDetails?.pack_price * 10 + " MAD"}
              </div>
            </div>
          </div>
...
export default CihBankOrderDetailsInfoModalPlans;
