...
interface TijariOrderDetailsInfoModalPlansProps {
  modalOpen: boolean;
  packDetails: any;
  setModalOpen: Function;
}

const TijariOrderDetailsInfoModalPlans: React.FC<
  TijariOrderDetailsInfoModalPlansProps
...
export default TijariOrderDetailsInfoModalPlans;
